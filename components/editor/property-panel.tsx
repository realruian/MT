...
/** 行高 icon（来自 public/icons/行高.svg，颜色 #11192D 50% 透明） */
function LineHeightIcon({ className = "size-4" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden
    >
      <g opacity="0.5" fill="#11192D">
        <path d="M13.4931 14.1667L9.81719 7.42747L6.14126 14.1667L5 14.1668L9.36408 6.10248C9.41153 6.01547 9.48303 5.94397 9.57004 5.89652C9.69021 5.83097 9.8315 5.81585 9.96282 5.85447C10.0941 5.89309 10.2047 5.9823 10.2703 6.10248L14.6344 14.1668L13.4931 14.1667Z" />
        <path d="M12.5698 11.6831H7.06445V10.6509H12.5698V11.6831Z" />
        <path d="M3.33398 16.0335C3.33398 15.923 3.42353 15.8335 3.53398 15.8335H16.4673C16.5778 15.8335 16.6673 15.923 16.6673 16.0335V16.6335C16.6673 16.744 16.5778 16.8335 16.4673 16.8335H3.53398C3.42353 16.8335 3.33398 16.744 3.33398 16.6335V16.0335Z" />
        <path d="M3.33398 3.5335C3.33398 3.42304 3.42353 3.3335 3.53398 3.3335H16.4673C16.5778 3.3335 16.6673 3.42304 16.6673 3.5335V4.1335C16.6673 4.24395 16.5778 4.3335 16.4673 4.3335H3.53398C3.42353 4.3335 3.33398 4.24395 3.33398 4.1335V3.5335Z" />
      </g>
    </svg>
  );
}

/** 字间距 icon（来自 public/icons/字间距.svg，颜色 #11192D 50% 透明） */
function LetterSpacingIcon({ className = "size-4" }: { className?: string }) {
  return (
    ...
    >
      <g opacity="0.5" fill="#11192D">
        <path d="M13.4931 14.1667L9.81719 7.42747L6.14126 14.1667L5 14.1668L9.36408 6.10248C9.41154 6.01547 9.48304 5.94397 9.57004 5.89652C9.69021 5.83097 9.8315 5.81585 9.96282 5.85447C10.0941 5.89309 10.2047 5.9823 10.2703 6.10248L14.6344 14.1668L13.4931 14.1667Z" />
        <path d="M12.5698 11.6831H7.06445V10.6509H12.5698V11.6831Z" />
        <path d="M4.05 3.41699C4.16046 3.41699 4.25 3.50654 4.25 3.61699V16.5503C4.25 16.6608 4.16046 16.7503 4.05 16.7503H3.45C3.33954 16.7503 3.25 16.6608 3.25 16.5503V3.61699C3.25 3.50654 3.33954 3.41699 3.45 3.41699H4.05Z" />
        <path d="M16.55 3.41699C16.6605 3.41699 16.75 3.50654 16.75 3.61699V16.5503C16.75 16.6608 16.6605 16.7503 16.55 16.7503H15.95C15.8395 16.7503 15.75 16.6608 15.75 16.5503V3.61699C15.75 3.50654 15.8395 3.41699 15.95 3.41699H16.55Z" />
      </g>
    </svg>
  );
}
