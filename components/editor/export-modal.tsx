    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-[#eee] px-6 py-4">
          <h2 className="text-base font-medium text-[#111]">选择下载范围</h2>
          <button
            type="button"
            aria-label="关闭"
            onClick={onClose}
        ...
        <div className="space-y-3 p-6">
          <button
            ...
            className="w-full rounded-lg border border-[#e5e5e5] bg-white p-4 text-left transition-colors hover:border-[#111]"
          >
            <div className="text-sm font-medium text-[#111]">导出全部资源位</div>
          ...
          <button
            ...
            className="w-full rounded-lg border border-[#e5e5e5] bg-white p-4 text-left transition-colors hover:border-[#111]"
          >
            <div className="text-sm font-medium text-[#111]">仅导出当前资源位</div>
